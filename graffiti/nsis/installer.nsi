...
;  File "QtXml4.dll"
  File "graffiti.exe"
  File "@CMAKE_SOURCE_DIR@/share/graffiti.ico"
  ...
  ; File association
  ${registerExtension} "$INSTDIR\graffiti.exe" ".gxg" "Graffiti XML Graphics"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\@PROJECT_NAME_LONG@\@PROJECT_NAME_SHORT@.lnk" "$INSTDIR\graffiti.exe" "" "$INSTDIR\graffiti.ico" 0
...
Section "Desktop Shortcut"
  ...
  CreateShortCut "$DESKTOP\@PROJECT_NAME_LONG@.lnk" "$INSTDIR\graffiti.exe" "" "$INSTDIR\graffiti.ico" 0
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\graffiti.exe"
  Delete "$INSTDIR\graffiti.ico"
...
;  Delete "$INSTDIR\QtXml4.dll"
  ...
  ${unregisterExtension} ".gxg" "Graffiti XML Graphics"
