...
<html>
 ...
 <body>
  ...
  <%-- Main JSP Content Begins  --%>
    ...
    <form name="courseware" enctype="multipart/form-data" method="POST" action="SaveCourseware" >
        <table class="form-noindent" border="0" bgcolor="#ccffaa" cellpadding="5" cellspacing="3" width="90%" align="center">
            <tbody>
                <tr>
                ...
                <td style="text-align: center;" nowrap="nowrap" valign="top">
                    ...
                    <font size="5">
                    Upload Courseware(PDFs, Videos, podcasts) on <img src="media/logo.gif" alt="HOAD!S" width="70" height="25">
                    </font>
                    </td>
                    ...
                    <td></td>
                    <td align="left">
                        <input type="submit" value="Upload Courseware" name="sub"/>
                    </td>
                    </tr>
